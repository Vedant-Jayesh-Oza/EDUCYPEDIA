                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="reg-form" action="RegisterServlet" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="user_answer">Which is your favourite sport? (Security Question)</label>
                                    <input name="user_answer" type="text" class="form-control" id="user_answer" aria-describedby="emailHelp" placeholder="Answer">
                                </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#reg-form').on('submit', function (event) {
                    ...
                    $("#sumbimt-btn").hide();
                    $("#loader").show();//send register servlet:
                    $.ajax({
                        url: "RegisterServlet",
                        type: 'POST',
                        data: form,
